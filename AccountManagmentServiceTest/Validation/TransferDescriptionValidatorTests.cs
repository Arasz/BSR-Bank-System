using AccountMangmentService.Transfer.Validation;
...
namespace AccountManagmentServiceTest.Validation
{
    public class TransferDescriptionValidatorTest
    {
        ...
        public void ReceiverAccount_AccountDoesntExist_ShouldReturnValidationErorr() => CreateValidator(accountExist: false)
            .ShouldHaveValidationErrorFor(description => description.ReceiverAccount, "78112241008528164913108077")
            .Should()
            .ContainSingle()
            .Which
            .ErrorCode
        ...
        public void ReceiverAccount_IncorrectAccountNumber_ShouldReturnValidationErorr() => CreateValidator()
            .ShouldHaveValidationErrorFor(description => description.ReceiverAccount, "78345541668528164913108077")
            .Should()
            .ContainSingle();
        ...
        public void SenderAccount_AccountDoesntExist_ShouldReturnValidationErorr() => CreateValidator(accountExist: false)
            .ShouldHaveValidationErrorFor(description => description.SenderAccount, "78112241008528164913108077")
            .Should()
            .ContainSingle()
            .Which
            .ErrorCode
