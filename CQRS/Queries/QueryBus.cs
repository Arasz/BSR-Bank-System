    ...
    public class QueryBus : IQueryBus
    {
        ...
        public TResult Send<TResult, TQuery>(TQuery query) where TQuery : IQuery<TResult>
        {
            ...
            var queryHandler =
                ...
                _queryHandlerFactory(new QueryHandlerKey(typeof(TResult), typeof(TQuery)));

            if (queryHandler == null)
                throw new NullHandlerException("Factory method returned null query handler",
                    typeof(IQueryHandler<TResult, TQuery>));
